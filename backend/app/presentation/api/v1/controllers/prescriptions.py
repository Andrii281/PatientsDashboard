...
from app.presentation.api.v1.mappers.prescriptions_mapper import PrescriptionsMapper
...
def get_prescriptions_by_id(
    ...
    response_mapper: PrescriptionsMapper = Depends()
):
    prescriptions = prescriptions_service.get_by_admission_id(admission_id)
    return response_mapper.get_prescriptions_by_id_to_response(prescriptions)